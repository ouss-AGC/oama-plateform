...
const StudentDetail: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const foundResult = history.find((r: QuizResult) => r.timestamp.toString() === timestamp);

        if (foundResult) {
            setResult(foundResult);

            // Calculate class stats for this discipline
            const disciplineResults = history.filter((r: QuizResult) => r.discipline === foundResult.discipline);
